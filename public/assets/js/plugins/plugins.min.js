!(function (t, e) {
            ...
            function (t, e, i) {
                ...
                t.exports = {
                    init: function (t) {
                        ...
                        return !0 === (e = v.disable) || ("mobile" === e && c.default.mobile()) || ("phone" === e && c.default.phone()) || ("tablet" === e && c.default.tablet()) || ("function" == typeof e && !0 === e()) || i
                            ...
                            : (v.disableMutationObserver ||
                              ...
                              window.addEventListener("resize", (0, h.default)(n, v.debounceDelay, !0)),
                              window.addEventListener("orientationchange", (0, h.default)(n, v.debounceDelay, !0)),
            ...
            function (m, t) {
                (function (t) {
                    ...
                    function o(s, n, t) {
                        ...
                        return (
                            (n = b(n) || 0),
                            y(t) && ((g = !!t.leading), (c = (v = "maxWait" in t) ? x(b(t.maxWait) || 0, n) : c), (i = "trailing" in t ? !!t.trailing : i)),
                            (e.cancel = function () {
                    ...
                    m.exports = function (t, e, i) {
                        ...
                        return y(i) && ((s = "leading" in i ? !!i.leading : s), (n = "trailing" in i ? !!i.trailing : n)), o(t, e, { leading: s, maxWait: e, trailing: n });
                    };
                }.call(
                    t,
                    (function () {
                ...
                if (r)
                    for (var l = 0, h = r.length; l < h; ++l) {
                        ...
                        g.hasOwnProperty(d) && ((f = g[d]), (f = Number(m[f]))),
                            null !== f &&
                                ("!" === u && ((i = f), (n = s = void 0), (s = "s"), (n = ""), (e = p) && (s = 1 === (e = e.replace(/(:|;|\s)/gi, "").split(/\,/)).length ? e[0] : ((n = e[0]), e[1])), (f = 1 < Math.abs(i) ? s : n)),
    ...
    (function (e, i) {
        ...
        function a(t, e, i) {
            ...
            return (
                ...
                n
                    ? ((this.elements = ((s = n), Array.isArray(s) ? s : "object" == typeof s && "number" == typeof s.length ? h.call(s) : [s])),
    ...
    (function (e) {
        ...
        function o(t, e, i) {
            ...
            a !== c &&
                ...
                a[1] && a[1] == +a[1] && (a[1] = +a[1]),
                e && e.values && e.values.length ? ((r.from = a[0] && e.values.indexOf(a[0])), (r.to = a[1] && e.values.indexOf(a[1]))) : ((r.from = a[0] && +a[0]), (r.to = a[1] && +a[1]))),
                l.extend(r, e),
                l.extend(r, s),
                (this.options = r),
                (this.update_check = {}),
        ...
        Function.prototype.bind ||
            ...
            (o.prototype = {
                ...
                drawLabels: function () {
                    ...
                    this.options &&
                        ...
                        this.options.hide_from_to ||
                            ("single" === this.options.type
                                ? ((t = o ? this.decorate(a[this.result.from]) : ((s = this._prettify(this.result.from)), this.decorate(s, this.result.from))),
                                ...
                                : ((i = o
                                      ? (this.options.decorate_both
                                            ? ((t = this.decorate(a[this.result.from])), (t += this.options.values_separator), (t += this.decorate(a[this.result.to])))
                                            : (t = this.decorate(a[this.result.from] + this.options.values_separator + a[this.result.to])),
                                      ...
                                      : ((s = this._prettify(this.result.from)),
                                        ...
                                        this.options.decorate_both
                                            ? ((t = this.decorate(s, this.result.from)), (t += this.options.values_separator), (t += this.decorate(n, this.result.to)))
                                            : (t = this.decorate(s + this.options.values_separator + n, this.result.to)),
                                  ...
                                  this.calcLabels(),
                                  (r = Math.min(this.labels.p_single_left, this.labels.p_from_left)),
                                        ...
                                        (d =
                                            this.result.from === this.result.to
                                                ? ("from" === this.target
                                                  ...
                                                  h)
                                                : ((this.$cache.from[0].style.visibility = "hidden"), (this.$cache.to[0].style.visibility = "hidden"), (this.$cache.single[0].style.visibility = "visible"), Math.max(l, h))))
                ...
                checkMinInterval: function (t, e, i) {
                    ...
                    return o.min_interval
                        ? ((s = this.convertToValue(t)), (n = this.convertToValue(e)), "from" === i ? n - s < o.min_interval && (s = n - o.min_interval) : s - n < o.min_interval && (s = n + o.min_interval), this.convertToPercent(s))
                        : t;
                },
                checkMaxInterval: function (t, e, i) {
                    ...
                    return o.max_interval
                        ? ((s = this.convertToValue(t)), (n = this.convertToValue(e)), "from" === i ? n - s > o.max_interval && (s = n - o.max_interval) : s - n > o.max_interval && (s = n + o.max_interval), this.convertToPercent(s))
                        : t;
                },
                ...
                appendGrid: function () {
                    if (this.options.grid) {
                        ...
                        for (this.calcGridMargin(), a.grid_snap && (l = r / a.step), 50 < l && (l = 50), i = this.toFixed(100 / l), 4 < l && (d = 3), 7 < l && (d = 2), 14 < l && (d = 1), 28 < l && (d = 0), t = 0; t < l + 1; t++) {
                            for (s = d, 100 < (h = this.toFixed(i * t)) && (h = 100), n = ((this.coords.big[t] = h) - i * (t - 1)) / (s + 1), e = 1; e <= s && 0 !== h; e++)
                                c += '<span class="irs-grid-pol small" style="left: ' + this.toFixed(h - n * e) + '%"></span>';
                            (c += '<span class="irs-grid-pol" style="left: ' + h + '%"></span>'),
                                (o = this.convertToValue(h)),
                                (c += '<span class="irs-grid-text js-grid-text-' + t + '" style="left: ' + h + '%">' + (o = a.values.length ? a.p_values[o] : this._prettify(o)) + "</span>");
                        }
            ...
            (function () {
                for (var o = 0, t = ["ms", "moz", "webkit", "o"], e = 0; e < t.length && !d.requestAnimationFrame; ++e)
            ...
            (l._transitionTo = function (t, e) {
                ...
                this.setPosition(t, e),
                    !r || this.isTransitioning
                        ? ((i = t - o), (s = e - a), ((n = {}).transform = this.getTranslate(i, s)), this.transition({ to: n, onTransitionEnd: { transform: this.layoutPosition }, isCleaning: !0 }))
                        : this.layoutPosition();
            }),
            ...
            (i._getItemLayoutPosition = function (t) {
                ...
                for (
                    var e = t.size.outerWidth % this.columnWidth,
                        ...
                        s = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, t),
    ...
    (function (a, r) {
        "function" == typeof define && define.amd
            ...
            : (a.Isotope = r(a, a.Outlayer, a.getSize, a.matchesSelector, a.fizzyUIUtils, a.Isotope.Item, a.Isotope.LayoutMode));
        ...
        var l = d.prototype;
        (l._create = function () {
            for (var t in ((this.itemGUID = 0), (this._sorters = {}), this._getSorters(), i.prototype._create.call(this), (this.modes = {}), (this.filteredItems = this.items), (this.sortHistory = ["original-order"]), a.modes))
    ...
    (function (i) {
        ...
        function (t, e, i) {
            ...
            function p() {
                y = l
                    ? (!a && document.body && (((a = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;"), document.body.appendChild(a)),
                      (a ? a.clientHeight : 0) || v.window.innerHeight || document.documentElement.clientHeight)
                ...
                f.length &&
                    (f.forEach(function (t, e) {
                        var i = t.instance,
                            ...
                            o = { width: n.width, height: n.height, top: n.top, bottom: n.bottom, wndW: v.window.innerWidth, wndH: y },
            ...
            function g(t, e) {
                ...
                for (; n < s; n += 1) if (("object" === c(e) || void 0 === e ? t[n].jarallax || (t[n].jarallax = new w(t[n], e)) : t[n].jarallax && (i = t[n].jarallax[e].apply(t[n].jarallax, a)), void 0 !== i)) return i;
                return t;
            }
            var b = 0,
                w =
                    (o(x.prototype, [
                        ...
                        },
                        {
                            key: "getWindowData",
                            value: function () {
                                return { width: v.window.innerWidth || document.documentElement.clientWidth, height: y, y: document.documentElement.scrollTop };
                            },
                        },
                        {
                            key: "initImg",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t,
                                    ...
                                    o = {};
                                s.options.keepImg ||
                                    ((t = s.$item.getAttribute("style")) && s.$item.setAttribute("data-jarallax-original-styles", t),
                                    s.image.useImgTag && (e = s.image.$item.getAttribute("style")) && s.image.$item.setAttribute("data-jarallax-original-styles", e)),
                                    "static" === s.css(s.$item, "position") && s.css(s.$item, { position: "relative" }),
                                    "auto" === s.css(s.$item, "z-index") && s.css(s.$item, { zIndex: 0 }),
                                    ...
                                    s.image.$container.setAttribute("id", "jarallax-container-".concat(s.instanceID)),
                                    ...
                                    ("opacity" !== s.options.type && "scale" !== s.options.type && "scale-opacity" !== s.options.type && 1 !== s.options.speed) || (s.image.position = "absolute"),
                                    ...
                                    "none" !== s.css(s.$item, "background-image") && s.css(s.$item, { "background-image": "none" }),
                                    s.addToParallaxList();
                            },
                        },
                        {
                            ...
                            value: function () {
                                f.push({ instance: this }), 1 === f.length && v.window.requestAnimationFrame(m);
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                "fixed" === this.image.position &&
                                    ...
                                    (n = "#jarallax-container-".concat(t.instanceID, " {\n           clip: rect(0 ").concat(i, "px ").concat(s, "px 0);\n           clip: rect(0, ").concat(i, "px, ").concat(s, "px, 0);\n        }")),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t,
                                    ...
                                    r = s;
                                return (
                                    o && (n < 0 ? ((a = n * Math.max(s, y)), y < s && (a -= n * (s - y))) : (a = n * (s + y)), 1 < n ? (r = Math.abs(a - y)) : n < 0 ? (r = a / n + Math.abs(a)) : (r += (y - s) * (1 - n)), (a /= 2)),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                var e,
                                    ...
                                    m = {},
                                    g = u;
                                c.options.elementInViewport && (g = c.options.elementInViewport.getBoundingClientRect()),
                                    (c.isElementInViewport = 0 <= g.bottom && 0 <= g.right && g.top <= y && g.left <= v.window.innerWidth),
                                    (t || c.isElementInViewport) &&
                                        ...
                                        (r = 1 - ((y - p) / (y + f)) * 2),
                                        (l = 1),
                                        f < y ? (l = 1 - (s || n) / f) : i <= y ? (l = i / y) : o <= y && (l = o / y),
                                        ("opacity" !== c.options.type && "scale-opacity" !== c.options.type && "scroll-opacity" !== c.options.type) || ((m.transform = "translate3d(0,0,0)"), (m.opacity = l)),
                                        ("scale" !== c.options.type && "scale-opacity" !== c.options.type) ||
                                            ((h = 1), c.options.speed < 0 ? (h -= c.options.speed * l) : (h += c.options.speed * (1 - l)), (m.transform = "scale(".concat(h, ") translate3d(0,0,0)"))),
                                        ("scroll" !== c.options.type && "scroll-opacity" !== c.options.type) ||
                                            ((d = c.parallaxScrollDistance * r), "absolute" === c.image.position && (d -= p), (m.transform = "translate3d(0,".concat(d, "px,0)"))),
                                        c.css(c.image.$item, m),
                                        c.options.onScroll &&
                                            c.options.onScroll.call(c, { section: u, beforeTop: e, beforeTopEnd: i, afterTop: s, beforeBottom: n, beforeBottomEnd: o, afterBottom: a, visiblePercent: l, fromViewportCenter: r }));
                            },
                        },
                        {
                            key: "onResize",
            ...
            function x(t, e) {
                ...
                h &&
                    ...
                    (i.image = { src: i.options.imgSrc || null, $container: null, useImgTag: !1, position: /iPad|iPhone|iPod|Android/.test(u.userAgent) ? "absolute" : "fixed" }),
                    ...
                    h(this).each(function (t, e) {
                        ...
                        n.attr("novalidate", "true"),
                            ...
                            n.submit(function () {
                                    ...
                                    h.ajax({
                                        ...
                                        success: function (e) {
                                            ...
                                            "en" !== r.language &&
                                                ...
                                                h.ajaxChimp.translations[r.language][h.ajaxChimp.responses[i]] &&
                                                (i = h.ajaxChimp.translations[r.language][h.ajaxChimp.responses[i]]),
                                                a.html(i),
                                                a.show(2e3),
                                ...
                                var e = "Submitting...";
                                return (
                                    "en" !== r.language && h.ajaxChimp.translations && h.ajaxChimp.translations[r.language] && h.ajaxChimp.translations[r.language].submit && (e = h.ajaxChimp.translations[r.language].submit),
                                    a.html(e).show(2e3),
                                    !1
                                );
                            });
        ...
        c.fn.animatedHeadline = function (t) {
            function a(t) {
                ...
                t.parents(".ah-headline").hasClass("type")
                    ? ((e = t.parent(".ah-words-wrapper")).addClass("selected").removeClass("waiting"),
                      setTimeout(function () {
                      ...
                      (function t(e, i, s, n) {
                          {
                              ...
                              e.removeClass("in").addClass("out"),
                                  ...
                                  e.is(":last-child") && c("html").hasClass("no-csstransitions") && ((o = r(i)), l(i, o));
                          }
                      })(t.find("i").eq(0), t, i, h.lettersDelay),
                      o(s.find("i").eq(0), s, i, h.lettersDelay))
                    : t.parents(".ah-headline").hasClass("clip")
                    ? t.parents(".ah-words-wrapper").animate({ width: "2px" }, h.revealDuration, function () {
                          l(t, s), n(s);
                      })
            ...
            function n(t, e) {
                t.parents(".ah-headline").hasClass("type")
                    ? (o(t.find("i").eq(0), t, !1, e), t.addClass("is-visible").removeClass("is-hidden"))
                    : t.parents(".ah-headline").hasClass("clip") &&
                      t.parents(".ah-words-wrapper").animate({ width: t.width() + 10 }, h.revealDuration, function () {
                          setTimeout(function () {
                              a(t);
            ...
            this.each(function () {
                ...
                h.animationType &&
                    ("type" == h.animationType || "rotate-2" == h.animationType || "rotate-3" == h.animationType || "scale" == h.animationType
                        ...
                        ? o.find(".ah-headline").addClass(h.animationType + " is-full-width")
                    ...
                    o.hasClass("loading-bar")
                        ...
                        : o.hasClass("clip")
                        ? ((e = (t = o.find(".ah-words-wrapper")).width() + 10), t.css("width", e))
        ...
        i.fn.counterUp = function (t) {
            ...
            return this.each(function () {
                ...
                l.waypoint(
                    function () {
                        for (
                            var t = [], e = h.time / h.delay, i = l.text(), s = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), n = (/^[0-9]+$/.test(i), /^[0-9]+\.[0-9]+$/.test(i)), o = n ? (i.split(".")[1] || []).length : 0, a = e;
                            1 <= a;
                            a--
                        ) {
    ...
    (function (i) {
        ...
        function o(t, e) {
            (this.settings = e),
                ...
                (this.rows = 0),
                (this.spinner = { phase: 0, timeSlot: 150, $el: d('<div class="jg-spinner"><span></span><span></span><span></span></div>'), intervalId: null }),
                (this.scrollBarOn = !1),
        ...
        (o.prototype.getSuffix = function (t, e) {
            for (var i = e < t ? t : e, s = 0; s < this.suffixRanges.length; s++) if (i <= this.suffixRanges[s]) return this.settings.sizeRangeSuffixes[this.suffixRanges[s]];
            ...
            (o.prototype.newSrc = function (t, e, i, s) {
                ...
                return (
                    this.settings.thumbnailPath
                        ...
                        : ((o = null !== (n = t.match(this.settings.extension)) ? n[0] : ""), (a = t.replace(this.settings.extension, "")), (a = this.removeSuffix(a, this.getUsedSuffix(a))), (a += this.getSuffix(e, i) + o)),
                    a
                );
            }),
            ...
            (o.prototype.displayEntryCaption = function (t) {
                ...
                null !== s && this.settings.captions
                    ? (null === (e = this.captionFromEntry(t)) &&
                          ((i = s.attr("alt")), this.isValidCaption(i) || (i = t.attr("title")), this.isValidCaption(i) && ((e = d('<div class="jg-caption">' + i + "</div>")), t.append(e), t.data("jg.createdCaption", !0))),
            ...
            (o.prototype.addCaptionEventsHandlers = function (t) {
                ...
                void 0 === e &&
                    ((e = { mouseenter: d.proxy(this.onEntryMouseEnterForCaption, this), mouseleave: d.proxy(this.onEntryMouseLeaveForCaption, this) }),
            ...
            (o.prototype.prepareBuildingRow = function (t, e) {
                ...
                if (e || (t && "hide" === this.settings.lastRow && !u)) {
                    for (i = 0; i < this.buildingRow.entriesBuff.length; i++)
                        (s = this.buildingRow.entriesBuff[i]), this.settings.cssAnimation ? s.removeClass("jg-entry-visible") : (s.stop().fadeTo(0, 0.1), s.find("> img, > a > img").fadeTo(0, 0));
                    return -1;
                }
                for (
                    t &&
                        ...
                        ((r = !1), 0 < this.rows && (r = ((c = (this.offY - this.border - this.settings.margins * this.rows) / this.rows) * this.buildingRow.aspectRatio) / h > this.settings.justifyThreshold)),
                        i = 0;
                    i < this.buildingRow.entriesBuff.length;
                    i++
                )
                    (n = (s = this.buildingRow.entriesBuff[i]).data("jg.width") / s.data("jg.height")),
                        (a = r ? ((o = i === this.buildingRow.entriesBuff.length - 1 ? h : d * n), d) : ((o = c * n), c)),
                        (h -= Math.round(o)),
            ...
            (o.prototype.flushRow = function (t, e) {
                ...
                if (e || (t && "hide" === s.lastRow && -1 === o)) this.clearBuildingRow();
                    ...
                    if ((this.maxRowHeight && this.maxRowHeight < this.buildingRow.height && (this.buildingRow.height = this.maxRowHeight), t && ("center" === s.lastRow || "right" === s.lastRow))) {
                        for (var a = this.galleryWidth - 2 * this.border - (this.buildingRow.entriesBuff.length - 1) * s.margins, r = 0; r < this.buildingRow.entriesBuff.length; r++)
                    ...
                    for (r = 0; r <= l; r++)
                        (i = this.buildingRow.entriesBuff[this.settings.rtl ? l - r : r]), this.displayEntry(i, n, this.offY, i.data("jg.jwidth"), i.data("jg.jheight"), this.buildingRow.height), (n += i.data("jg.jwidth") + s.margins);
                    (this.galleryHeightToSet = this.offY + this.buildingRow.height + this.border),
                        this.setGalleryTempHeight(this.galleryHeightToSet + this.getSpinnerHeight()),
                        (!t || (this.buildingRow.height <= s.rowHeight && o)) && ((this.offY += this.buildingRow.height + s.margins), (this.rows += 1), this.clearBuildingRow(), this.settings.triggerEvent.call(this, "jg.rowflush"));
                }
            });
        var e = 0;
        (o.prototype.rememberGalleryHeight = function () {
                ...
                this.checkWidthIntervalId = setInterval(
                    d.proxy(function () {
                        ...
                        this.$gallery.is(":visible") &&
                            ((t = parseFloat(this.$gallery.width())), Math.abs(t - this.galleryWidth) > this.settings.refreshSensitivity && ((this.galleryWidth = t), this.rewind(), this.rememberGalleryHeight(), this.startImgAnalyzer(!0)));
                    }, this),
            ...
            (o.prototype.updateEntries = function (t) {
                var e, i;
                return (
                    0 < (i = t && null != this.lastFetchedEntry ? ((e = this.getSelectorWithoutSpinner()), d(this.lastFetchedEntry).nextAll(e).toArray()) : ((this.entries = []), this.getAllEntries())).length &&
                        (d.isFunction(this.settings.sort) ? (i = this.sortArray(i)) : this.settings.randomize && (i = this.shuffleArray(i)),
                    ...
                    if ((i.addClass("jg-entry"), !0 !== i.data("jg.loaded") && "skipped" !== i.data("jg.loaded")))
                        if ((null !== h.settings.rel && i.attr("rel", h.settings.rel), null !== h.settings.target && i.attr("target", h.settings.target), null !== s)) {
                            ...
                            if (!1 === h.settings.waitThumbnailsLoad || !n) {
                                ...
                                if (("svg" === s.prop("tagName") && ((o = parseFloat(s[0].getBBox().width)), (a = parseFloat(s[0].getBBox().height))), !isNaN(o) && !isNaN(a)))
                                    return i.data("jg.width", o), i.data("jg.height", a), i.data("jg.loaded", "skipped"), (l = !0), h.startImgAnalyzer(!1), !0;
                            }
                            i.data("jg.loaded", !1),
                                (r = !0),
        ...
        (t.prototype = {
            ...
            open: function (t) {
                ...
                if (!m.isOpen) {
                    ...
                    p("BeforeOpen"),
                        ...
                        m.fixedContentPos ? m.wrap.css({ overflow: m.st.overflowY, overflowX: "hidden", overflowY: m.st.overflowY }) : m.wrap.css({ top: _.scrollTop(), position: "absolute" }),
            ...
            _close: function () {
                ...
                m.bgOverlay.detach(),
                    ...
                    m.fixedContentPos && ((t = { marginRight: "" }), m.isIE7 ? d("body, html").css("overflow", "") : (t.overflow = ""), d("html").css(t)),
            ...
            updateSize: function (t) {
                var e, i;
                m.isIOS ? ((e = document.documentElement.clientWidth / window.innerWidth), (i = window.innerHeight * e), m.wrap.css("height", i), (m.wH = i)) : (m.wH = t || _.height()),
            ...
            updateItemHTML: function () {
                ...
                p("BeforeChange", [m.currItem ? m.currItem.type : "", i]),
                    (m.currItem = t),
                    m.currTemplate[i] || ((e = !!m.st[i] && m.st[i].markup), p("FirstMarkupParse", e), (m.currTemplate[i] = !e || d(e))),
                            ...
                            void (1 < (o = t.split("_")).length
                                ? 0 < (i = n.find(w + "-" + o[0])).length &&
                                  ("replaceWith" === (s = o[1])
                                      ...
                                      ? i.is("img")
                                          ? i.attr("src", e)
                                          : i.replaceWith(d("<img>").attr("src", e).attr("class", i.attr("class")))
                                      : i.attr(o[1], e))
                                : n.find(w + "-" + t).html(e))
                        );
                        var i, s;
            ...
            (d.fn.magnificPopup = function (t) {
                ...
                return (
                    "string" == typeof t
                        ...
                        : ((t = d.extend(!0, {}, t)), r ? n.data("magnificPopup", t) : (n[0].magnificPopup = t), m.addGroup(n, t)),
                    n
                );
            });
        function S() {
            ...
            proto: {
                ...
                getInline: function (t, e) {
                    if ((S(), t.src)) {
                        ...
                        return (
                            n.length
                                ? ((i = n[0].parentNode) && i.tagName && (E || ((T = s.hiddenClass), (E = u(T)), (T = "mfp-" + T)), (C = n.after(E).detach().removeClass(T))), m.updateStatus("ready"))
            ...
            proto: {
                ...
                getImage: function (t, e) {
                    ...
                    return (
                        ...
                        m.resizeImage(),
                        t.hasSize
                            ? (P && clearInterval(P), t.loadError ? (e.addClass("mfp-loading"), m.updateStatus("error", a.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), m.updateStatus("ready")))
                        ...
                        !(!o || !o.enabled) &&
                            ...
                            c("BuildControls" + t, function () {
                                ...
                                1 < m.items.length &&
                                    ...
                                    !m.arrowLeft &&
                                    ((t = o.arrowMarkup),
                                    (e = m.arrowLeft = d(t.replace(/%title%/gi, o.tPrev).replace(/%dir%/gi, "left")).addClass(a)),
                                    (i = m.arrowRight = d(t.replace(/%title%/gi, o.tNext).replace(/%dir%/gi, "right")).addClass(a)),
                                    e.click(function () {
                                        m.prev();
                                    }),
                                    i.click(function () {
        ...
        (i.prototype = {
                ...
                (l.options = c.extend(!0, {}, c.fn.selectric.defaults, l.options, t)),
                    ...
                    l.options.disableOnMobile && l.utils.isMobile()
                        ...
                        : ((l.classes = l.getClassNames()),
                          (e = c("<input/>", { class: l.classes.input, readonly: l.utils.isMobile() })),
                          (i = c("<div/>", { class: l.classes.items, tabindex: -1 })),
                          (s = c("<div/>", { class: l.classes.scroll })),
                          (n = c("<div/>", { class: l.classes.prefix, html: l.options.arrowButtonMarkup })),
                          (o = c("<span/>", { class: "label" })),
                          (a = l.$element.wrap("<div/>").parent().append(n.prepend(o), i, e)),
                          (r = c("<div/>", { class: l.classes.hideselect })),
                          (l.elements = { input: e, items: i, itemsScroll: s, wrapper: n, label: o, outerWrapper: a }),
            ...
            getClassNames: function () {
                var s = this,
                    ...
                    o = {};
                return (
                    c.each("Input Items Open Disabled TempShow HideSelect Wrapper Focus Hover Responsive Above Below Scroll Group GroupLabel".split(" "), function (t, e) {
                        var i = n.prefix + e;
            ...
            setLabel: function () {
                ...
                s.state.multiple
                    ? ((t = 0 === (t = c.isArray(s.state.currValue) ? s.state.currValue : [s.state.currValue]).length ? [0] : t),
                      ...
                      s.options.multiple.maxLabelEntries &&
                          (e.length >= s.options.multiple.maxLabelEntries + 1 ? (e = e.slice(0, s.options.multiple.maxLabelEntries)).push(c.isFunction(n) ? n({ text: "..." }) : s.utils.format(n, { text: "..." })) : e.slice(e.length - 1)),
                      s.elements.label.html(e.join(s.options.multiple.separator)))
                    : ((i = s.lookupItems[s.state.currValue]), s.elements.label.html(c.isFunction(n) ? n(i) : s.utils.format(n, i)));
            },
            populate: function () {
                var s = this,
                    ...
                    t.length &&
                        (t.each(function (t) {
                            var i,
                                e = c(this);
                            e.is("optgroup")
                                ? ((i = { element: e, label: e.prop("label"), groupDisabled: e.prop("disabled"), items: [] }),
                                  e.children().each(function (t) {
                                      var e = c(this);
                                      (i.items[t] = s.getItemData(o, e, i.groupDisabled || e.prop("disabled"))), (s.lookupItems[o] = i.items[t]), o++;
                                  }),
                                  (s.items[t] = i))
                                : ((s.items[t] = s.getItemData(o, e, e.prop("disabled"))), (s.lookupItems[o] = s.items[t]), o++);
                        }),
                        s.setLabel(),
                        s.elements.items.append(s.elements.itemsScroll.html(s.getItemsMarkup(s.items))));
            },
            getItemData: function (t, e, i) {
                return { index: t, element: e, value: e.val(), className: e.prop("class"), text: e.html(), slug: c.trim(this.utils.replaceDiacritics(e.html())), alt: e.attr("data-alt"), selected: e.prop("selected"), disabled: i };
            },
            getItemsMarkup: function (t) {
                var i = this,
                    s = "<ul>";
                return (
                    c.isFunction(i.options.listBuilder) && i.options.listBuilder && (t = i.options.listBuilder(t)),
            ...
            getItemMarkup: function (t, e) {
                ...
                return i.utils.format(
                    ...
                    c.isFunction(s) ? i.utils.format(s(e, this.$element, t), e) : i.utils.format(s, n)
                );
            },
            ...
            bindEvents: function () {
                ...
                o.elements.outerWrapper.on("mouseenter.sl mouseleave.sl", function (t) {
                    c(this).toggleClass(o.classes.hover, "mouseenter" === t.type),
                        o.options.openOnHover && (clearTimeout(o.closeTimer), "mouseleave" === t.type ? (o.closeTimer = setTimeout(c.proxy(o.close, o), o.options.hoverIntentTimeout)) : o.open());
                }),
                                    ...
                                    t.length &&
                                        c.each(o.items, function (t, e) {
                                            if (!e.disabled) {
                                                ...
                                                if (e.alt) for (var i = e.alt.split("|"), s = 0; s < i.length && i[s]; s++) if (n.test(i[s].trim())) return void o.highlight(t);
                                            }
                                        });
                            })),
                    o.$li.on({
            ...
            isInViewport: function () {
                ...
                !0 === r.options.forceRenderAbove
                    ...
                    : ((t = l.scrollTop()),
                      (e = l.height()),
                      (s = (i = r.elements.outerWrapper.offset().top) + r.elements.outerWrapper.outerHeight() + r.itemsHeight <= t + e),
                      (n = i - r.itemsHeight > t),
                      (a = !(o = !s && n)),
            ...
            open: function (t) {
                ...
                n.utils.triggerCallback("BeforeOpen", n),
                    t && (t.preventDefault(), n.options.stopPropagation && t.stopPropagation()),
                    n.state.enabled &&
                        ...
                        n.options.preventWindowScroll &&
                            e.on("mousewheel.sl DOMMouseScroll.sl", "." + n.classes.scroll, function (t) {
                                ...
                                "detail" in e && (s = -1 * e.detail),
                                    ...
                                    ((i === this.scrollHeight - n.itemsInnerHeight && s < 0) || (0 === i && 0 < s)) && t.preventDefault();
                            }),
            ...
            select: function (t) {
                ...
                i.utils.triggerCallback("BeforeSelect", i, t),
                    void 0 === t ||
                        ...
                        (i.state.multiple
                            ? ((i.state.selectedIdx = c.isArray(i.state.selectedIdx) ? i.state.selectedIdx : [i.state.selectedIdx]),
                              -1 !== (e = c.inArray(t, i.state.selectedIdx)) ? i.state.selectedIdx.splice(e, 1) : i.state.selectedIdx.push(t),
                              s
        ...
        })(
            {
                ...
                4: [
                    function (c, u, t) {
                        (function (t) {
                            for (
                                var s, n, o, a = c("performance-now"), e = "undefined" == typeof window ? t : window, i = ["moz", "webkit"], r = "AnimationFrame", l = e["request" + r], h = e["cancel" + r] || e["cancelRequest" + r], d = 0;
                                !l && d < i.length;
                                d++
                            )
                                (l = e[i[d] + "Request" + r]), (h = e[i[d] + "Cancel" + r] || e[i[d] + "CancelRequest" + r]);
                            (l && h) ||
                                ((n = s = 0),
                                (o = []),
                                (l = function (t) {
                                    ...
                                    switch (t) {
                                        ...
                                        case "3D":
                                            a &&
                                                ...
                                                (n = !1),
                                                document.body || ((n = !0), (i.style.overflow = "hidden"), i.appendChild(e), (e.style.overflow = "hidden"), (e.style.background = "")),
                                                e.appendChild(o),
                                                (o.style[d] = "translate3d(1px,1px,1px)"),
                                                (l = void 0 !== (r = window.getComputedStyle(o).getPropertyValue(h)) && 0 < r.length && "none" !== r),
                                                (i.style.overflow = s),
                                                e.removeChild(o),
                                                n && (e.removeAttribute("style"), e.parentNode.removeChild(e)));
                                    }
                                    return l;
                                },
                                css: function (t, e, i) {
                ...
                var M,
                    I = function () {
                        ...
                        for (C = [], T = window.innerHeight, E = window.innerWidth, t = S.options.breakpoints, M = E < t[0] ? "xs" : E >= t[0] && E < t[1] ? "sm" : E >= t[1] && E < t[2] ? "md" : "lg", z(), t = 0; t < S.elems.length; t++) {
                            var e = void 0,
                                ...
                                w = !0;
                            o || a || r || l ? (e = { xs: o, sm: a, md: r, lg: l }) : (w = !1),
                                (o = S.options.wrapper ? S.options.wrapper.scrollTop : window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop),
                                S.options.relativeToWrapper && (o = (window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop) - S.options.wrapper.offsetTop);
                    ...
                    z = function () {
                        ...
                        return (
                            ...
                            (a = S.options.wrapper ? S.options.wrapper.scrollLeft : (document.documentElement || document.body.parentNode || document.body).scrollLeft || window.pageXOffset),
                            S.options.relativeToWrapper && (o = ((document.documentElement || document.body.parentNode || document.body).scrollTop || window.pageYOffset) - S.options.wrapper.offsetTop),
                            !!((t != o && S.options.vertical) || (e != a && S.options.horizontal))
                        );
                    },
                    $ = function (t, e, i, s, n) {
                        var o = {};
                    ...
                    d = function () {
                        window.removeEventListener("resize", d),
                            ...
                            (S.options.wrapper ? S.options.wrapper : window).removeEventListener("scroll", d),
                            (S.options.wrapper ? S.options.wrapper : document).removeEventListener("touchmove", d),
                            (s = i(P));
                    },
                    P = function () {
                        z() && !1 === k
                            ...
                            : ((s = null),
                              ...
                              (S.options.wrapper ? S.options.wrapper : window).addEventListener("scroll", d, !!n && { passive: !0 }),
                              (S.options.wrapper ? S.options.wrapper : document).addEventListener("touchmove", d, !!n && { passive: !0 }));
                    },
                    L = function () {
                        for (var t = 0; t < S.elems.length; t++) {
                            var e = C[t].verticalScrollAxis.toLowerCase(),
                                ...
                                n = -1 != i.indexOf("x") ? a : 0,
                                i = -1 != i.indexOf("y") ? a : 0;
                            (i = (s = $((s + n - C[t].left + E) / (C[t].width + E), (e + i - C[t].top + T) / (C[t].height + T), C[t].speed, C[t].verticalSpeed, C[t].horizontalSpeed)).y - C[t].baseY),
                                (e = s.x - C[t].baseX),
                                null !== C[t].min && (S.options.vertical && !S.options.horizontal && (i = i <= C[t].min ? C[t].min : i), S.options.horizontal && !S.options.vertical && (e = e <= C[t].min ? C[t].min : e)),
                                null != C[t].minY && (i = i <= C[t].minY ? C[t].minY : i),
                                null != C[t].minX && (e = e <= C[t].minX ? C[t].minX : e),
                                null !== C[t].max && (S.options.vertical && !S.options.horizontal && (i = i >= C[t].max ? C[t].max : i), S.options.horizontal && !S.options.vertical && (e = e >= C[t].max ? C[t].max : e)),
                                null != C[t].maxY && (i = i >= C[t].maxY ? C[t].maxY : i),
                                null != C[t].maxX && (e = e >= C[t].maxX ? C[t].maxX : e),
                                (S.elems[t].style[h] = "translate3d(" + (S.options.horizontal ? e : "0") + "px," + (S.options.vertical ? i : "0") + "px," + C[t].zindex + "px) " + C[t].transform);
                        }
                ...
                return (
                    ...
                    (!(x("body").width() < t.minWidth) &&
                        ...
                        0 === x("#theia-sticky-sidebar-stylesheet-" + b.namespace).length &&
                            x("head").append(x('<style id="theia-sticky-sidebar-stylesheet-' + b.namespace + '">.theiaStickySidebar:after {content: ""; display: table; clear: both;}</style>')),
                        i.each(function () {
                            function y() {
                            ...
                            (t.sidebar = x(this)),
                                ...
                                0 == t.stickySidebar.length &&
                                    ...
                                    t.sidebar
                                        ...
                                        .remove(),
                                    (t.stickySidebar = x("<div>").addClass("theiaStickySidebar").append(t.sidebar.children())),
                            ...
                            t.stickySidebar.css("padding-top", 1),
                                ...
                                0 == o ? (t.stickySidebar.css("padding-top", 0), (t.stickySidebarPaddingTop = 0)) : (t.stickySidebarPaddingTop = 1),
                                0 == a ? (t.stickySidebar.css("padding-bottom", 0), (t.stickySidebarPaddingBottom = 0)) : (t.stickySidebarPaddingBottom = 1),
                                ...
                                (t.onScroll = function (t) {
                                    if (t.stickySidebar.is(":visible")) {
                                        ...
                                        if (t.options.disableOnResponsiveLayouts) if (t.sidebar.outerWidth("none" == t.sidebar.css("float")) + 50 > t.container.width()) return void y();
                                        var e,
                                            i,
                                            s,
                                            n,
                                            ...
                                            m = "static";
                                        f >= t.sidebar.offset().top + (t.paddingTop - t.options.additionalMarginTop) &&
                                            ((e = t.paddingTop + b.additionalMarginTop),
                                            (i = t.paddingBottom + t.marginBottom + b.additionalMarginBottom),
                                            ...
                                            (a = t.stickySidebar.outerHeight() + e + i < x(window).height() ? o + t.stickySidebar.outerHeight() : x(window).height() - t.marginBottom - t.paddingBottom - b.additionalMarginBottom),
                                            (r = s - f + t.paddingTop),
                                            (l = n - f - t.paddingBottom - t.marginBottom),
                                            (h = t.stickySidebar.offset().top - f),
                                            (d = t.previousScrollTop - f),
                                            "fixed" == t.stickySidebar.css("position") && "modern" == t.options.sidebarBehavior && (h += d),
                                            "stick-to-top" == t.options.sidebarBehavior && (h = b.additionalMarginTop),
                                            "stick-to-bottom" == t.options.sidebarBehavior && (h = a - t.stickySidebar.outerHeight()),
                                            (h = 0 < d ? Math.min(h, o) : Math.max(h, a - t.stickySidebar.outerHeight())),
                                            (h = Math.max(h, r)),
                                            (h = Math.min(h, l - t.stickySidebar.outerHeight())),
                                            (m =
                                                (!(c = t.container.height() == t.stickySidebar.outerHeight()) && h == o) || (!c && h == a - t.stickySidebar.outerHeight())
                                                    ? "fixed"
                                                    : f + h - t.sidebar.offset().top - t.paddingTop <= b.additionalMarginTop
                                                    ? "static"
                                                    : "absolute")),
                                            "fixed" == m
                                                ...
                                                ? ((p = {}),
                                                  "absolute" != t.stickySidebar.css("position") &&
                                                      ((p.position = "absolute"), (p.transform = "translateY(" + (f + h - t.sidebar.offset().top - t.stickySidebarPaddingTop - t.stickySidebarPaddingBottom) + "px)"), (p.top = "0px")),
                                                  (p.width = w(t.stickySidebar) + "px"),
                                                  (p.left = ""),
                                                  t.stickySidebar.css(p))
                                                : "static" == m && y(),
                                            "static" != m && 1 == t.options.updateSidebarHeight && t.sidebar.css({ "min-height": t.stickySidebar.outerHeight() + t.stickySidebar.offset().top - t.sidebar.offset().top + t.paddingBottom }),
    ...
    (function (r, d) {
                      ...
                      (s.copyAttributes &&
                          (function (t, e) {
                              for (var i, s, n = t.attributes, o = 0; o < n[w]; o++) {
                                  ...
                                  -1 == u.indexOf(l) &&
                                      ((s = i.value),
                                      l == h ? ((r = e.firstElementChild) && r.localName.toLowerCase() == h ? (a = r) : ((a = d[c + "NS"]("http://www.w3.org/2000/svg", h)), e.insertBefore(a, r)), (a.textContent = s)) : e[b](l, s));
                              }
                          })(t, e),
        ...
        var t = (function t(e, i) {
                    ...
                    if (e) Array.isArray(e) ? e.push(t) : t();
                        ...
                        if (p) {
                            function o(t) {
                                ...
                                t === M
                                    ...
                                    : t === I
                                    ? R(l, h)
                                    : ((i = t[0]), (s = t[1]), (n = t[2]), f && (i === T ? ((i = A((e = j(s, !1)), !1)), (t[0] = i), (t[2] = i && O(e))) : i && (s = n.replace(k, C + L++))), (e = e || j(s, !1)), D(l, e, u, h)),
                                    d();
                            }
                            var a;
                        ...
                        (m = function (t, e) {
                            var i,
                                ...
                                n,
                                o,
                                a = t instanceof Document ? t.documentElement : j(e, !0),
                                r = h.afterLoad;
                            !r || ((i = r(a, e) || a) && ((e = (s = "string" == typeof i) ? i : O(a)), (a = s ? j(i, !0) : i))),
                                a instanceof SVGElement ? ((n = T), f && (n = A(a, !1)), p && ((o = n && O(a)), c([n, e, o])), D(l, a, u, h)) : (R(l, h), c(I)),
                                d();
                        }),
                            (g = function () {
                                H(l, h), c(M), d();
            ...
            return (
                $ && ((s = 'img[onload^="' + e + '("]{visibility:hidden;}'), (o = d[y]("head")[0]) && (((n = d[c](x)).type = "text/css"), n.appendChild(d.createTextNode(s)), o.appendChild(n))),
    ...
    (function (t, e) {
        ...
        function z(t, e) {
            ...
            if (t)
                if ("string" == typeof t) {
                    ...
                    } else for (n = e || "#" !== t[0] || t.match(/[ .<>:~]/) ? (e || m).querySelectorAll(t.trim()) : [m.getElementById(t.trim().split("#")[1])], s = 0; s < n.length; s += 1) n[s] && i.push(n[s]);
                } else if (t.nodeType || t === nt || t === m) i.push(t);
                else if (0 < t.length && t[0].nodeType) for (s = 0; s < t.length; s += 1) i.push(t[s]);
            return new l(i);
        }
        function o(t) {
        ...
        var e = {
            ...
            on: function () {
                ...
                function n(t) {
                    ...
                    if (e) {
                        ...
                        else for (var s = z(e).parents(), n = 0; n < s.length; n += 1) z(s[n]).is(o) && a.apply(s[n], i);
                    }
                }
                function r(t) {
                ...
                for (var l, h = i.split(" "), d = 0; d < this.length; d += 1) {
                    ...
                    if (o)
                        for (l = 0; l < h.length; l += 1) {
                            var u = h[l];
                            c.dom7LiveListeners || (c.dom7LiveListeners = {}), c.dom7LiveListeners[u] || (c.dom7LiveListeners[u] = []), c.dom7LiveListeners[u].push({ listener: a, proxyListener: n }), c.addEventListener(u, n, s);
                        }
                    else
                        for (l = 0; l < h.length; l += 1) {
                            var p = h[l];
                            c.dom7Listeners || (c.dom7Listeners = {}), c.dom7Listeners[p] || (c.dom7Listeners[p] = []), c.dom7Listeners[p].push({ listener: a, proxyListener: r }), c.addEventListener(p, r, s);
                        }
                }
                return this;
            },
                ...
                for (var i = t[0].split(" "), s = t[1], n = 0; n < i.length; n += 1)
                    for (var o = i[n], a = 0; a < this.length; a += 1) {
                        var r = this[a],
                            l = void 0;
                        try {
                            l = new nt.CustomEvent(o, { detail: s, bubbles: !0, cancelable: !0 });
                        } catch (t) {
            ...
            transitionEnd: function (e) {
                var i,
                    ...
                    n = this;
                function o(t) {
                    if (t.target === this) for (e.call(this, t), i = 0; i < s.length; i += 1) n.off(s[i], o);
                }
            ...
            append: function () {
                ...
                for (var s = 0; s < e.length; s += 1) {
                    ...
                    for (var n = 0; n < this.length; n += 1)
                        ...
                        } else if (t instanceof l) for (var a = 0; a < t.length; a += 1) this[n].appendChild(t[a]);
            ...
            parents: function (t) {
                for (var e = [], i = 0; i < this.length; i += 1) for (var s = this[i].parentNode; s; ) (t && !z(s).is(t)) || e.push(s), (s = s.parentNode);
                return z(o(e));
            },
            closest: function (t) {
                var e = this;
            ...
            children: function (t) {
                for (var e = [], i = 0; i < this.length; i += 1) for (var s = this[i].childNodes, n = 0; n < s.length; n += 1) t ? 1 === s[n].nodeType && z(s[n]).is(t) && e.push(s[n]) : 1 === s[n].nodeType && e.push(s[n]);
                return new l(o(e));
            },
            filter: function (t) {
            ...
            add: function () {
                for (var t = [], e = arguments.length; e--; ) t[e] = arguments[e];
                for (var i = 0; i < t.length; i += 1) for (var s = z(t[i]), n = 0; n < s.length; n += 1) (this[this.length] = s[n]), (this.length += 1);
                return this;
            },
            styles: function () {
        ...
        var ot = {
                ...
                getTranslate: function (t, e) {
                    ...
                    return (
                        ...
                        "x" === e && (s = nt.WebKitCSSMatrix ? n.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])),
                        "y" === e && (s = nt.WebKitCSSMatrix ? n.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])),
                        s || 0
                    );
                },
                parseUrlQuery: function (t) {
                    ...
                    if ("string" == typeof a && a.length)
                        for (
                            n = (i = (a = -1 < a.indexOf("?") ? a.replace(/\S*\?/, "") : "").split("&").filter(function (t) {
                                return "" !== t;
                            })).length,
                                e = 0;
                            e < n;
                            ...
                            (s = i[e].replace(/#\S+/g, "").split("=")), (o[decodeURIComponent(s[0])] = void 0 === s[1] ? void 0 : decodeURIComponent(s[1]) || "");
                    return o;
                },
                isObject: function (t) {
        ...
        (t.prototype.on = function (t, e, i) {
            ...
            (t.prototype.emit = function () {
                ...
                return (
                    o.eventsListeners &&
                        ((n = "string" == typeof t[0] || Array.isArray(t[0]) ? ((i = t[0]), (s = t.slice(1, t.length)), o) : ((i = t[0].events), (s = t[0].data), t[0].context || o)),
        ...
        var s,
            ...
            x = {
                updateSize: function () {
                    ...
                    (0 === e && this.isHorizontal()) ||
                        ...
                        ot.extend(this, { width: e, height: i, size: this.isHorizontal() ? e : i }));
                },
                updateSlides: function () {
                    ...
                    if (void 0 !== i) {
                        "string" == typeof y && 0 <= y.indexOf("%") && (y = (parseFloat(y.replace("%", "")) / 100) * i),
                            ...
                            1 < e.slidesPerColumn &&
                                ((m = Math.floor(l / e.slidesPerColumn) === l / this.params.slidesPerColumn ? l : Math.ceil(l / e.slidesPerColumn) * e.slidesPerColumn),
                        ...
                        for (var _, S, T, E, C, k = e.slidesPerColumn, M = m / k, I = Math.floor(l / e.slidesPerColumn), z = 0; z < l; z += 1) {
                            ...
                            1 < e.slidesPerColumn &&
                                ...
                                "row" === e.slidesPerColumnFill && 1 < e.slidesPerGroup
                                    ? ((L = Math.floor(z / (e.slidesPerGroup * e.slidesPerColumn))),
                                      (O = z - e.slidesPerColumn * e.slidesPerGroup * L),
                                      (A = 0 === L ? e.slidesPerGroup : Math.min(Math.ceil((l - L * k * e.slidesPerGroup) / k), e.slidesPerGroup)),
                                      (D = ($ = O - (P = Math.floor(O / A)) * A + L * e.slidesPerGroup) + (P * m) / k),
                                      J.css({ "-webkit-box-ordinal-group": D, "-moz-box-ordinal-group": D, "-ms-flex-order": D, "-webkit-order": D, order: D }))
                                    : "column" === e.slidesPerColumnFill
                                    ? ((P = z - ($ = Math.floor(z / k)) * k), (I < $ || ($ === I && P === k - 1)) && (P += 1) >= k && ((P = 0), ($ += 1)))
                                    : ($ = z - (P = Math.floor(z / M)) * M),
                                J.css("margin-" + (this.isHorizontal() ? "top" : "left"), 0 !== P && e.spaceBetween && e.spaceBetween + "px")),
                                "none" !== J.css("display") &&
                                    ("auto" === e.slidesPerView
                                        ? ((j = nt.getComputedStyle(J[0], null)),
                                          ...
                                          (X = e.roundLengths
                                              ? this.isHorizontal()
                                                  ...
                                                  : J.outerHeight(!0)
                                              : this.isHorizontal()
                                              ? ((H = parseFloat(j.getPropertyValue("width"))),
                                                (W = parseFloat(j.getPropertyValue("padding-left"))),
                                                (B = parseFloat(j.getPropertyValue("padding-right"))),
                                                (N = parseFloat(j.getPropertyValue("margin-left"))),
                                                (Y = parseFloat(j.getPropertyValue("margin-right"))),
                                                (q = j.getPropertyValue("box-sizing")) && "border-box" === q ? H + N + Y : H + W + B + N + Y)
                                              : ((G = parseFloat(j.getPropertyValue("height"))),
                                                (V = parseFloat(j.getPropertyValue("padding-top"))),
                                                (U = parseFloat(j.getPropertyValue("padding-bottom"))),
                                                (Q = parseFloat(j.getPropertyValue("margin-top"))),
                                                (K = parseFloat(j.getPropertyValue("margin-bottom"))),
                                                (Z = j.getPropertyValue("box-sizing")) && "border-box" === Z ? G + Q + K : G + V + U + Q + K)),
                                          R && (J[0].style.transform = R),
                                          F && (J[0].style.webkitTransform = F),
                                          e.roundLengths && (X = Math.floor(X)))
                                        : ((X = (i - (e.slidesPerView - 1) * y) / e.slidesPerView), e.roundLengths && (X = Math.floor(X)), r[z] && (this.isHorizontal() ? (r[z].style.width = X + "px") : (r[z].style.height = X + "px"))),
                                    ...
                                    e.centeredSlides
                                        ? ((b = b + X / 2 + w / 2 + y),
                                          ...
                                          d.push(b))
                                        : (e.roundLengths && (b = Math.floor(b)), (x - Math.min(this.params.slidesPerGroupSkip, x)) % this.params.slidesPerGroup == 0 && h.push(b), d.push(b), (b = b + X + y)),
                        ...
                        if (
                            ...
                            s && n && ("slide" === e.effect || "coverflow" === e.effect) && t.css({ width: this.virtualSize + e.spaceBetween + "px" }),
                        ...
                        0 === h.length && (h = [0]),
                            0 !== e.spaceBetween && (this.isHorizontal() ? (s ? r.filter(u).css({ marginLeft: y + "px" }) : r.filter(u).css({ marginRight: y + "px" })) : r.filter(u).css({ marginBottom: y + "px" })),
                            e.centeredSlides &&
                            ...
                            ot.extend(this, { slides: r, snapGrid: h, slidesGrid: d, slidesSizesGrid: c }),
                    ...
                    if (0 !== i.length) {
                        ...
                        for (var o = 0; o < i.length; o += 1) {
                            ...
                            (e.watchSlidesVisibility || (e.centeredSlides && e.autoHeight)) &&
                                ...
                                ((0 <= a && a < this.size - 1) || (1 < r && r <= this.size) || (a <= 0 && r >= this.size)) && (this.visibleSlides.push(l), this.visibleSlidesIndexes.push(o), i.eq(o).addClass(e.slideVisibleClass))),
                                (l.progress = s ? -h : h);
                        }
                    ...
                    e.removeClass(i.slideActiveClass + " " + i.slideNextClass + " " + i.slidePrevClass + " " + i.slideDuplicateActiveClass + " " + i.slideDuplicateNextClass + " " + i.slideDuplicatePrevClass),
                        ...
                        i.loop &&
                            (t.hasClass(i.slideDuplicateClass)
                                ? s.children("." + i.slideClass + ":not(." + i.slideDuplicateClass + ')[data-swiper-slide-index="' + o + '"]').addClass(i.slideDuplicateActiveClass)
                                : s.children("." + i.slideClass + "." + i.slideDuplicateClass + '[data-swiper-slide-index="' + o + '"]').addClass(i.slideDuplicateActiveClass));
                    var r = t
                    ...
                    i.loop && 0 === l.length && (l = e.eq(-1)).addClass(i.slidePrevClass),
                        i.loop &&
                            (r.hasClass(i.slideDuplicateClass)
                                ? s.children("." + i.slideClass + ":not(." + i.slideDuplicateClass + ')[data-swiper-slide-index="' + r.attr("data-swiper-slide-index") + '"]').addClass(i.slideDuplicateNextClass)
                                : s.children("." + i.slideClass + "." + i.slideDuplicateClass + '[data-swiper-slide-index="' + r.attr("data-swiper-slide-index") + '"]').addClass(i.slideDuplicateNextClass),
                ...
                updateActiveIndex: function (t) {
                    ...
                    (i = 0 <= a.indexOf(n) ? a.indexOf(n) : (e = Math.min(r.slidesPerGroupSkip, c)) + Math.floor((c - e) / r.slidesPerGroup)) >= a.length && (i = a.length - 1),
                        c !== l
                            ? ((s = parseInt(this.slides.eq(c).attr("data-swiper-slide-index") || c, 10)),
                              ot.extend(this, { snapIndex: i, realIndex: s, previousIndex: l, activeIndex: c }),
                ...
                updateClickedSlide: function (t) {
                    ...
                    (this.clickedSlide = i),
                        this.virtual && this.params.virtual.enabled ? (this.clickedIndex = parseInt(z(i).attr("data-swiper-slide-index"), 10)) : (this.clickedIndex = z(i).index()),
            ...
            _ = {
                ...
                setTranslate: function (t, e) {
                    ...
                    this.isHorizontal() ? (r = i ? -t : t) : (l = t),
                        ...
                        s.cssMode ? (o[this.isHorizontal() ? "scrollLeft" : "scrollTop"] = this.isHorizontal() ? -r : -l) : s.virtualTranslate || n.transform("translate3d(" + r + "px, " + l + "px, 0px)"),
                ...
                translateTo: function (t, e, i, s, n) {
                    ...
                    return (
                        0 === e
                            ? (a.setTransition(0), a.setTranslate(c), i && (a.emit("beforeTransitionStart", e, n), a.emit("transitionEnd")))
                            : (a.setTransition(e),
                              a.setTranslate(c),
                              i && (a.emit("beforeTransitionStart", e, n), a.emit("transitionStart")),
                              a.animating ||
                                  ((a.animating = !0),
            ...
            S = {
                slideTo: function (t, e, i, s) {
                    ...
                    var g,
                        v = -l[m];
                    if ((o.updateProgress(v), r.normalizeSlideIndex)) for (var y = 0; y < h.length; y += 1) -Math.floor(100 * v) >= Math.floor(100 * h[y]) && (a = y);
                    ...
                    if (((g = c < a ? "next" : a < c ? "prev" : "reset"), (u && -v === o.translate) || (!u && v === o.translate)))
                        return o.updateActiveIndex(a), r.autoHeight && o.updateAutoHeight(), o.updateSlidesClasses(), "slide" !== r.effect && o.setTranslate(v), "reset" != g && (o.transitionStart(i, g), o.transitionEnd(i, g)), !1;
                    if (r.cssMode) {
                    ...
                    return (
                        0 === e
                            ? (o.setTransition(0), o.setTranslate(v), o.updateActiveIndex(a), o.updateSlidesClasses(), o.emit("beforeTransitionStart", e, s), o.transitionStart(i, g), o.transitionEnd(i, g))
                            : (o.setTransition(e),
                              o.setTranslate(v),
                ...
                slidePrev: function (t, e, i) {
                    ...
                    return (
                        ...
                        void 0 !== u && (h = a.indexOf(u)) < 0 && (h = this.activeIndex - 1),
                ...
                slideToClosest: function (t, e, i, s) {
                    ...
                    return (
                        h >= this.snapGrid[l]
                            ? h - (n = this.snapGrid[l]) > (this.snapGrid[l + 1] - n) * s && (a += this.params.slidesPerGroup)
                            : h - (o = this.snapGrid[l - 1]) <= (this.snapGrid[l] - o) * s && (a -= this.params.slidesPerGroup),
                        (a = Math.max(a, 0)),
                ...
                slideToClickedSlide: function () {
                    ...
                    if (i.loop) {
                        ...
                        (t = parseInt(z(e.clickedSlide).attr("data-swiper-slide-index"), 10)),
                            i.centeredSlides
            ...
            T = {
                ...
                loopFix: function () {
                    ...
                    e < s
                        ? ((t = i.length - 3 * s + e), (t += s), this.slideTo(t, 0, !1, !0) && 0 != l && this.setTranslate((r ? -this.translate : this.translate) - l))
                        : e >= i.length - s && ((t = -i.length + e + s), (t += s), this.slideTo(t, 0, !1, !0) && 0 != l && this.setTranslate((r ? -this.translate : this.translate) - l)),
            ...
            M =
                ...
                (w = "MacIntel" === s),
                !c && w && E.touch && ((1024 === r && 1366 === h) || (834 === r && 1194 === h) || (834 === r && 1112 === h) || (768 === r && 1024 === h)) && ((c = n.match(/(Version)\/([\d.]+)/)), (w = !1)),
                (a.ie = f),
                (a.edge = g),
                (a.firefox = v),
                d && !y && ((a.os = "android"), (a.osVersion = d[2]), (a.android = !0), (a.androidChrome = 0 <= n.toLowerCase().indexOf("chrome"))),
                (c || p || u) && ((a.os = "ios"), (a.ios = !0)),
                p && !u && ((a.osVersion = p[2].replace(/_/g, ".")), (a.iphone = !0)),
                c && ((a.osVersion = c[2].replace(/_/g, ".")), (a.ipad = !0)),
                u && ((a.osVersion = u[3] ? u[3].replace(/_/g, ".") : null), (a.ipod = !0)),
                a.ios && a.osVersion && 0 <= n.indexOf("Version/") && "10" === a.osVersion.split(".")[0] && (a.osVersion = n.toLowerCase().split("version/")[1].split(" ")[0]),
                (a.webView = !(!(p || c || u) || (!n.match(/.*AppleWebKit(?!.*Safari)/i) && !nt.navigator.standalone)) || (nt.matchMedia && nt.matchMedia("(display-mode: standalone)").matches)),
                (a.webview = a.webView),
                (a.standalone = a.webView),
                (a.desktop = !(a.ios || a.android) || b),
                a.desktop && ((a.electron = b), (a.macos = w), (a.windows = y), a.macos && (a.os = "macos"), a.windows && (a.os = "windows")),
        ...
        var L,
                ...
                events: {
                    attachEvents: function () {
                        ...
                        (this.onTouchStart = function (t) {
                            ...
                            (this.animating && d.preventInteractionOnTransition) ||
                                ...
                                (i = z(e.target)),
                                ("wrapper" === d.touchEventsTarget && !i.closest(this.wrapperEl).length) ||
                                    ((h.isTouchEvent = "touchstart" === e.type), (!h.isTouchEvent && "which" in e && 3 === e.which) || (!h.isTouchEvent && "button" in e && 0 < e.button) || (h.isTouched && h.isMoved)) ||
                                    (d.noSwiping && i.closest(d.noSwipingSelector ? d.noSwipingSelector : "." + d.noSwipingClass)[0]
                                        ? (this.allowClick = !0)
                                        : (d.swipeHandler && !i.closest(d.swipeHandler)[0]) ||
                                          ...
                                          (o && (s <= a || s >= nt.screen.width - a)) ||
                                              (ot.extend(h, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }),
                                              (c.startX = s),
                                              (c.startY = n),
                                              ...
                                              "touchstart" !== e.type &&
                                                  ...
                                                  m.activeElement && z(m.activeElement).is(h.formElements) && m.activeElement !== i[0] && m.activeElement.blur(),
                                                  (l = r && this.allowTouchMove && d.touchStartPreventDefault),
                                                  (d.touchStartForcePreventDefault || l) && e.preventDefault()),
                            ...
                            (this.onTouchMove = function (t) {
                                ...
                                if ((o.originalEvent && (o = o.originalEvent), e.isTouched)) {
                                    if (!e.isTouchEvent || "mousemove" !== o.type) {
                                        ...
                                        if (!this.allowTouchMove) return (this.allowClick = !1), void (e.isTouched && (ot.extend(s, { startX: r, startY: l, currentX: r, currentY: l }), (e.touchStartTime = ot.now())));
                                                ...
                                                if (
                                                    (void 0 === e.isScrolling &&
                                                        ((this.isHorizontal() && s.currentY === s.startY) || (this.isVertical() && s.currentX === s.startX)
                                                            ? (e.isScrolling = !1)
                                                            : 25 <= d * d + c * c && ((h = (180 * Math.atan2(Math.abs(c), Math.abs(d))) / Math.PI), (e.isScrolling = this.isHorizontal() ? h > i.touchAngle : 90 - h > i.touchAngle))),
                                                    ...
                                                    i.followFinger &&
                                                        ...
                                                        i.freeMode &&
                                                            ...
                                                            e.velocities.push({ position: s[this.isHorizontal() ? "currentX" : "currentY"], time: ot.now() })),
                            ...
                            (this.onTouchEnd = function (t) {
                                ...
                                if (
                                    (e.allowClick && (e.updateClickedSlide(h), e.emit("tap click", h), g < 300 && m - i.lastClickTime < 300 && e.emit("doubleTap doubleClick", h)),
                                    ...
                                    if (s.freeMode) {
                                        ...
                                        if (s.freeModeMomentum) {
                                            1 < i.velocities.length
                                                ? ((c = i.velocities.pop()),
                                                  ...
                                                  (150 < f || 300 < ot.now() - c.time) && (e.velocity = 0))
                                                : (e.velocity = 0),
                                            ...
                                            if (b < e.maxTranslate())
                                                s.freeModeMomentumBounce ? (b + e.maxTranslate() < -E && (b = e.maxTranslate() - E), (w = e.maxTranslate()), (T = !0), (i.allowMomentumBounce = !0)) : (b = e.maxTranslate()),
                                                    s.loop && s.centeredSlides && (x = !0);
                                            else if (b > e.minTranslate())
                                                s.freeModeMomentumBounce ? (b - e.minTranslate() > E && (b = e.minTranslate() + E), (w = e.minTranslate()), (T = !0), (i.allowMomentumBounce = !0)) : (b = e.minTranslate()),
                                                    s.loop && s.centeredSlides && (x = !0);
                                            ...
                                            if (
                                                ...
                                                (v = o ? Math.abs((-b - e.translate) / e.velocity) : Math.abs((b - e.translate) / e.velocity)),
                                                    s.freeModeSticky && (v = (_ = Math.abs((o ? -b : b) - e.translate)) < (S = e.slidesSizesGrid[e.activeIndex]) ? s.speed : _ < 2 * S ? 1.5 * s.speed : 2.5 * s.speed);
                                        ...
                                        if (g > s.longSwipesMs) {
                                            ...
                                            !e.navigation || (h.target !== e.navigation.nextEl && h.target !== e.navigation.prevEl)
                                                ? ("next" === e.swipeDirection && e.slideTo(M + L), "prev" === e.swipeDirection && e.slideTo(M))
                        ...
                        !E.touch && E.pointerEvents
                            ? (i.addEventListener(e.start, this.onTouchStart, !1), m.addEventListener(e.move, this.onTouchMove, o), m.addEventListener(e.end, this.onTouchEnd, !1))
                            : (E.touch &&
                                  ((n = !("touchstart" !== e.start || !E.passiveListener || !t.passiveListeners) && { passive: !0, capture: !1 }),
                                  i.addEventListener(e.start, this.onTouchStart, n),
                                  i.addEventListener(e.move, this.onTouchMove, E.passiveListener ? { passive: !1, capture: o } : o),
                                  i.addEventListener(e.end, this.onTouchEnd, n),
                                  e.cancel && i.addEventListener(e.cancel, this.onTouchEnd, n),
                                  $ || (m.addEventListener("touchstart", P), ($ = !0))),
                              ((t.simulateTouch && !M.ios && !M.android) || (t.simulateTouch && !E.touch && M.ios)) &&
                                  (i.addEventListener("mousedown", this.onTouchStart, !1), m.addEventListener("mousemove", this.onTouchMove, o), m.addEventListener("mouseup", this.onTouchEnd, !1))),
                            ...
                            t.updateOnWindowResize ? this.on(M.ios || M.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I, !0) : this.on("observerUpdate", I, !0);
                    },
                    detachEvents: function () {
                        var t,
                            ...
                            o = !!e.nested;
                        !E.touch && E.pointerEvents
                            ? (s.removeEventListener(i.start, this.onTouchStart, !1), m.removeEventListener(i.move, this.onTouchMove, o), m.removeEventListener(i.end, this.onTouchEnd, !1))
                            : (E.touch &&
                                  ((t = !("onTouchStart" !== i.start || !E.passiveListener || !e.passiveListeners) && { passive: !0, capture: !1 }),
                                  ...
                                  i.cancel && s.removeEventListener(i.cancel, this.onTouchEnd, t)),
                              ((e.simulateTouch && !M.ios && !M.android) || (e.simulateTouch && !E.touch && M.ios)) &&
                                  (s.removeEventListener("mousedown", this.onTouchStart, !1), m.removeEventListener("mousemove", this.onTouchMove, o), m.removeEventListener("mouseup", this.onTouchEnd, !1))),
                            ...
                            this.off(M.ios || M.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I);
                    },
                },
                breakpoints: {
                    setBreakpoint: function () {
                        ...
                        !u ||
                            ...
                            ((s = this.getBreakpoint(u)) &&
                                ...
                                a && !r
                                    ? c.removeClass(d.containerModifierClass + "multirow " + d.containerModifierClass + "multirow-column")
                                    : !a && r && (c.addClass(d.containerModifierClass + "multirow"), "column" === o.slidesPerColumnFill && c.addClass(d.containerModifierClass + "multirow-column")),
                                ...
                                ot.extend(this, { allowTouchMove: this.params.allowTouchMove, allowSlideNext: this.params.allowSlideNext, allowSlidePrev: this.params.allowSlidePrev }),
                                (this.currentBreakpoint = s),
            ...
            j = (function (c) {
                    ...
                    if ((t = h[0])) {
                        ...
                        return (
                            ...
                            t && t.shadowRoot && t.shadowRoot.querySelector
                                ? ((a = z(t.shadowRoot.querySelector("." + o.params.wrapperClass))).children = function (t) {
                                      return h.children(t);
                                  })
                            ...
                            ot.extend(o, {
                                ...
                                touchEvents:
                                    ...
                                    E.pointerEvents && (l = ["pointerdown", "pointermove", "pointerup"]),
                                    (o.touchEventsTouch = { start: r[0], move: r[1], end: r[2], cancel: r[3] }),
                ...
                return (
                    ((u.prototype.constructor = u).prototype.slidesPerViewDynamic = function () {
                        ...
                        } else for (var d = n + 1; d < e.length; d += 1) i[d] - i[n] < s && (o += 1);
                        return o;
                    }),
                    ...
                    (u.prototype.destroy = function (t, e) {
                        ...
                        return (
                            void 0 === i.params ||
                                ...
                                !1 !== t && ((i.$el[0].swiper = null), i.$el.data("swiper", null), ot.deleteProps(i)),
                                (i.destroyed = !0)),
                            null
                        );
                    }),
            ...
            W = { name: "browser", proto: { browser: H }, static: { browser: H } },
            B = {
                name: "resize",
                create: function () {
                    var t = this;
            ...
            N = {
                ...
                attach: function (t, e) {
                    ...
                    s.observe(t, { attributes: void 0 === e.attributes || e.attributes, childList: void 0 === e.childList || e.childList, characterData: void 0 === e.characterData || e.characterData }), i.observer.observers.push(s);
                },
                init: function () {
            ...
            Y = {
                ...
                create: function () {
                    ot.extend(this, { observer: { init: N.init.bind(this), attach: N.attach.bind(this), destroy: N.destroy.bind(this), observers: [] } });
                },
                on: {
                    init: function () {
                        this.observer.init();
            ...
            q = {
                update: function (t) {
                    ...
                    if ((ot.extend(e.virtual, { from: w, to: x, offset: _, slidesGrid: e.slidesGrid }), d === w && c === x && !t)) return e.slidesGrid !== p && _ !== m && e.slides.css(y, _ + "px"), void e.updateProgress();
                    ...
                    else for (var C = d; C <= c; C += 1) (C < w || x < C) && e.$wrapperEl.find("." + e.params.slideClass + '[data-swiper-slide-index="' + C + '"]').remove();
                    ...
                    if (!(i.shiftKey || i.altKey || i.ctrlKey || i.metaKey || (m.activeElement && m.activeElement.nodeName && ("input" === m.activeElement.nodeName.toLowerCase() || "textarea" === m.activeElement.nodeName.toLowerCase())))) {
                        ...
                        this.isHorizontal()
                            ? ((33 !== s && 34 !== s && 37 !== s && 39 !== s) || (i.preventDefault ? i.preventDefault() : (i.returnValue = !1)),
                              ...
                              (((33 !== s && 37 !== s) || e) && ((34 !== s && 39 !== s) || !e)) || this.slidePrev())
            ...
            V = {
                ...
                create: function () {
                    ot.extend(this, { keyboard: { enabled: !1, enable: G.enable.bind(this), disable: G.disable.bind(this), handle: G.handle.bind(this) } });
                },
                on: {
                    init: function () {
            ...
            U = {
                ...
                event: function () {
                    return -1 < nt.navigator.userAgent.indexOf("firefox")
                        ? "DOMMouseScroll"
                        : ((e = "onwheel" in m) || ((t = m.createElement("div")).setAttribute("onwheel", "return;"), (e = "function" == typeof t.onwheel)),
                          !e && m.implementation && m.implementation.hasFeature && !0 !== m.implementation.hasFeature("", "") && (e = m.implementation.hasFeature("Events.wheel", "3.0")),
                          e ? "wheel" : "mousewheel");
                    var t, e;
                },
                ...
                handle: function (t) {
                    ...
                    if ((s.invert && (o = -o), i.params.freeMode)) {
                        var l = { time: ot.now(), delta: Math.abs(o), direction: Math.sign(o) },
                        ...
                        if (!d) {
                            ...
                            if (
                                ...
                                i.updateActiveIndex(),
                                i.updateSlidesClasses(),
                                ((!g && i.isBeginning) || (!v && i.isEnd)) && i.updateSlidesClasses(),
                                i.params.freeModeSticky &&
                                    (clearTimeout(i.mousewheel.timeout),
                                    (i.mousewheel.timeout = void 0),
                                    15 <= (c = i.mousewheel.recentWheelEvents).length && c.shift(),
                                    ...
                                    i.mousewheel.timeout ||
                                        (i.mousewheel.timeout = ot.nextTick(function () {
                                            (i.mousewheel.lastEventBeforeSnap = l), c.splice(0), i.slideToClosest(i.params.speed, !0, void 0, 0.5);
                                        }, 500))),
                                d || i.emit("scroll", e),
                        ...
                        var y = { time: ot.now(), delta: Math.abs(o), direction: Math.sign(o), raw: t },
                ...
                enable: function () {
                    ...
                    var e = this.$el;
                    return (
                        "container" !== this.params.mousewheel.eventsTarged && (e = z(this.params.mousewheel.eventsTarged)),
            ...
            Q = {
                update: function () {
                    ...
                    this.params.loop ||
                        ...
                        (i = t.$prevEl) && 0 < i.length && (this.isBeginning ? i.addClass(s.disabledClass) : i.removeClass(s.disabledClass), i[this.params.watchOverflow && this.isLocked ? "addClass" : "removeClass"](s.lockClass)),
                        e && 0 < e.length && (this.isEnd ? e.addClass(s.disabledClass) : e.removeClass(s.disabledClass), e[this.params.watchOverflow && this.isLocked ? "addClass" : "removeClass"](s.lockClass)));
                },
                ...
                init: function () {
                    ...
                    (i.nextEl || i.prevEl) &&
                        (i.nextEl && ((t = z(i.nextEl)), this.params.uniqueNavElements && "string" == typeof i.nextEl && 1 < t.length && 1 === this.$el.find(i.nextEl).length && (t = this.$el.find(i.nextEl))),
                        i.prevEl && ((e = z(i.prevEl)), this.params.uniqueNavElements && "string" == typeof i.prevEl && 1 < e.length && 1 === this.$el.find(i.prevEl).length && (e = this.$el.find(i.prevEl))),
                        t && 0 < t.length && t.on("click", this.navigation.onNextClick),
                        e && 0 < e.length && e.on("click", this.navigation.onPrevClick),
                        ot.extend(this.navigation, { $nextEl: t, nextEl: t && t[0], $prevEl: e, prevEl: e && e[0] }));
                },
                destroy: function () {
            ...
            K = {
                update: function () {
                    ...
                    if (n.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                        ...
                        if (
                            (this.params.loop
                                ? ((o = Math.ceil((this.activeIndex - this.loopedSlides) / this.params.slidesPerGroup)) > r - 1 - 2 * this.loopedSlides && (o -= r - 2 * this.loopedSlides),
                                  h - 1 < o && (o -= h),
                                  o < 0 && "bullets" !== this.params.paginationType && (o = h + o))
                                : (o = void 0 !== this.snapIndex ? this.snapIndex : this.activeIndex || 0),
                            ...
                            if (
                                ...
                                g.each(function (t, e) {
                                    ...
                                    s === o && i.addClass(n.bulletActiveClass),
                                        n.dynamicBullets &&
                                            (d <= s && s <= c && i.addClass(n.bulletActiveClass + "-main"),
                                            s === d &&
                                                i
                                                    .prev()
                        ...
                        "fraction" === n.type && (l.find("." + n.currentClass).text(n.formatFractionCurrent(o + 1)), l.find("." + n.totalClass).text(n.formatFractionTotal(h))),
                            "progressbar" === n.type &&
                            ...
                            "custom" === n.type && n.renderCustom ? (l.html(n.renderCustom(this, o + 1, h)), this.emit("paginationRender", this, l[0])) : this.emit("paginationUpdate", this, l[0]),
                ...
                render: function () {
                    ...
                    if (t.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                        var e = this.virtual && this.params.virtual.enabled ? this.virtual.slides.length : this.slides.length,
                            ...
                            s = "";
                        if ("bullets" === t.type) {
                            for (var n = this.params.loop ? Math.ceil((e - 2 * this.loopedSlides) / this.params.slidesPerGroup) : this.snapGrid.length, o = 0; o < n; o += 1)
                                t.renderBullet ? (s += t.renderBullet.call(this, o, t.bulletClass)) : (s += "<" + t.bulletElement + ' class="' + t.bulletClass + '"></' + t.bulletElement + ">");
            ...
            Z = {
                setTranslate: function () {
                    ...
                    this.params.scrollbar.el &&
                        ...
                        (h = (n - (l = s)) * i),
                        e ? (0 < (h = -h) ? ((l = s - h), (h = 0)) : n < -h + s && (l = n + h)) : h < 0 ? ((l = s + h), (h = 0)) : n < h + s && (l = n - h),
                        this.isHorizontal() ? (o.transform("translate3d(" + h + "px, 0, 0)"), (o[0].style.width = l + "px")) : (o.transform("translate3d(0px, " + h + "px, 0)"), (o[0].style.height = l + "px")),
                        r.hide &&
                ...
                updateSize: function () {
                    ...
                    this.params.scrollbar.el &&
                        ...
                        this.isHorizontal() ? (e[0].style.width = a + "px") : (e[0].style.height = a + "px"),
                        (i[0].style.display = 1 <= n ? "none" : ""),
                        this.params.scrollbar.hide && (i[0].style.opacity = 0),
                        ot.extend(t, { trackSize: s, divider: n, moveDivider: o, dragSize: a }),
                ...
                onDragStart: function (t) {
                    ...
                    (this.scrollbar.isTouched = !0),
                        (this.scrollbar.dragStartPos = t.target === o[0] || t.target === o ? i.getPointerPosition(t) - t.target.getBoundingClientRect()[this.isHorizontal() ? "left" : "top"] : null),
                        t.preventDefault(),
                        t.stopPropagation(),
                        s.transition(100),
                        o.transition(100),
                ...
                enableDraggable: function () {
                    ...
                    this.params.scrollbar.el &&
                        ...
                        (s = this.params),
                        (n = t.$el[0]),
                        (o = !(!E.passiveListener || !s.passiveListeners) && { passive: !1, capture: !1 }),
                        (a = !(!E.passiveListener || !s.passiveListeners) && { passive: !0, capture: !1 }),
                        E.touch
                            ? (n.addEventListener(e.start, this.scrollbar.onDragStart, o), n.addEventListener(e.move, this.scrollbar.onDragMove, o), n.addEventListener(e.end, this.scrollbar.onDragEnd, a))
                            : (n.addEventListener(i.start, this.scrollbar.onDragStart, o), m.addEventListener(i.move, this.scrollbar.onDragMove, o), m.addEventListener(i.end, this.scrollbar.onDragEnd, a)));
                },
                disableDraggable: function () {
                    ...
                    this.params.scrollbar.el &&
                        ...
                        (a = !(!E.passiveListener || !s.passiveListeners) && { passive: !0, capture: !1 }),
                        E.touch
                            ? (n.removeEventListener(e.start, this.scrollbar.onDragStart, o), n.removeEventListener(e.move, this.scrollbar.onDragMove, o), n.removeEventListener(e.end, this.scrollbar.onDragEnd, a))
                            : (n.removeEventListener(i.start, this.scrollbar.onDragStart, o), m.removeEventListener(i.move, this.scrollbar.onDragMove, o), m.removeEventListener(i.end, this.scrollbar.onDragEnd, a)));
                },
                init: function () {
                    var t, e, i, s, n;
                    this.params.scrollbar.el &&
                        ...
                        0 === (n = s.find("." + this.params.scrollbar.dragClass)).length && ((n = z('<div class="' + this.params.scrollbar.dragClass + '"></div>')), s.append(n)),
            ...
            J = {
                setTransform: function (t, e) {
                    ...
                    l || h ? ((l = l || "0"), (h = h || "0")) : this.isHorizontal() ? ((l = r), (h = "0")) : ((h = r), (l = "0")),
                        (l = 0 <= l.indexOf("%") ? parseInt(l, 10) * e * a + "%" : l * e * a + "px"),
                        (h = 0 <= h.indexOf("%") ? parseInt(h, 10) * e + "%" : h * e + "px"),
                        null != c && ((i = c - (c - 1) * (1 - Math.abs(e))), (o[0].style.opacity = i)),
                        null == d ? o.transform("translate3d(" + l + ", " + h + ", 0px)") : ((s = d - (d - 1) * (1 - Math.abs(e))), o.transform("translate3d(" + l + ", " + h + ", 0px) scale(" + s + ")"));
                },
                setTranslate: function () {
                    var s = this,
                        t = s.$el,
                    ...
                    t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function (t, e) {
                        ...
                        e.each(function (t, e) {
                            var i = e.progress;
                            1 < s.params.slidesPerGroup && "auto" !== s.params.slidesPerView && (i += Math.ceil(t / 2) - n * (o.length - 1)),
            ...
            tt = {
                ...
                onGestureChange: function (t) {
                    ...
                    s.$imageEl &&
                        0 !== s.$imageEl.length &&
                        ((i.scale = E.gestures ? t.scale * i.currentScale : (s.scaleMove / s.scaleStart) * i.currentScale),
                ...
                enable: function () {
                    ...
                    s.enabled ||
                        ((s.enabled = !0),
                        (t = !("touchstart" !== this.touchEvents.start || !E.passiveListener || !this.params.passiveListeners) && { passive: !0, capture: !1 }),
                        (e = !E.passiveListener || { passive: !1, capture: !0 }),
                        (i = "." + this.params.slideClass),
                        E.gestures
                            ? (this.$wrapperEl.on("gesturestart", i, s.onGestureStart, t), this.$wrapperEl.on("gesturechange", i, s.onGestureChange, t), this.$wrapperEl.on("gestureend", i, s.onGestureEnd, t))
                            : "touchstart" === this.touchEvents.start &&
                              (this.$wrapperEl.on(this.touchEvents.start, i, s.onGestureStart, t),
                              this.$wrapperEl.on(this.touchEvents.move, i, s.onGestureChange, e),
                              this.$wrapperEl.on(this.touchEvents.end, i, s.onGestureEnd, t),
                              this.touchEvents.cancel && this.$wrapperEl.on(this.touchEvents.cancel, i, s.onGestureEnd, t)),
                        this.$wrapperEl.on(this.touchEvents.move, "." + this.params.zoom.containerClass, s.onTouchMove, e));
                },
                disable: function () {
                    var t,
                        e,
                    ...
                    s.enabled &&
                        ...
                        (i = "." + this.params.slideClass),
                        E.gestures
                            ? (this.$wrapperEl.off("gesturestart", i, s.onGestureStart, t), this.$wrapperEl.off("gesturechange", i, s.onGestureChange, t), this.$wrapperEl.off("gestureend", i, s.onGestureEnd, t))
                            : "touchstart" === this.touchEvents.start &&
                              (this.$wrapperEl.off(this.touchEvents.start, i, s.onGestureStart, t),
                              this.$wrapperEl.off(this.touchEvents.move, i, s.onGestureChange, e),
                              this.$wrapperEl.off(this.touchEvents.end, i, s.onGestureEnd, t),
                              this.touchEvents.cancel && this.$wrapperEl.off(this.touchEvents.cancel, i, s.onGestureEnd, t)),
                        this.$wrapperEl.off(this.touchEvents.move, "." + this.params.zoom.containerClass, s.onTouchMove, e));
                },
            },
            et = {
                loadInSlide: function (t, l) {
                    ...
                    void 0 !== t &&
                        0 !== d.slides.length &&
                        ((e = (h = d.virtual && d.params.virtual.enabled ? d.$wrapperEl.children("." + d.params.slideClass + '[data-swiper-slide-index="' + t + '"]') : d.slides.eq(t)).find(
                            "." + c.elementClass + ":not(." + c.loadedClass + "):not(." + c.loadingClass + ")"
                        )),
                        !h.hasClass(c.elementClass) || h.hasClass(c.loadedClass) || h.hasClass(c.loadingClass) || (e = e.add(h[0])),
                        0 !== e.length &&
                            e.each(function (t, e) {
                                var s = z(e);
                                ...
                                d.loadImage(s[0], o || n, a, r, !1, function () {
                                    ...
                                    null == d ||
                                        ...
                                        (n
                                            ...
                                            : (a && (s.attr("srcset", a), s.removeAttr("data-srcset")), r && (s.attr("sizes", r), s.removeAttr("data-sizes")), o && (s.attr("src", o), s.removeAttr("data-src"))),
                                        ...
                                        d.params.loop &&
                                            ...
                                            h.hasClass(d.params.slideDuplicateClass)
                                                ...
                                                : ((i = d.$wrapperEl.children("." + d.params.slideDuplicateClass + '[data-swiper-slide-index="' + t + '"]')), d.lazy.loadInSlide(i.index(), !1))),
                ...
                load: function () {
                    ...
                    else if (1 < r) for (var d = t; d < t + r; d += 1) l(d) && s.lazy.loadInSlide(d);
            ...
            it = {
                        ...
                        (this.interpolate = function (t) {
                            return t
                                ? ((a = (function (t, e) {
                                  ...
                                  (o = a - 1),
                                  ((t - this.x[o]) * (this.y[a] - this.y[o])) / (this.x[a] - this.x[o]) + this.y[o])
                                : 0;
                        }),
                        this
                    );
                ...
                setTranslate: function (t, e) {
                    ...
                    if (Array.isArray(o)) for (var r = 0; r < o.length; r += 1) o[r] !== e && o[r] instanceof j && a(o[r]);
                ...
                setTransition: function (e, t) {
                    ...
                    if (Array.isArray(n)) for (i = 0; i < n.length; i += 1) n[i] !== t && n[i] instanceof j && o(n[i]);
            ...
            at = {
                ...
                setHistory: function (t, e) {
                    ...
                    this.history.initialized &&
                        ...
                        ((n = nt.history.state) && n.value === s) || (this.params.history.replaceState ? nt.history.replaceState({ value: s }, null, s) : nt.history.pushState({ value: s }, null, s)));
                },
                slugify: function (t) {
                    return t
                        .toString()
                ...
                setHash: function () {
                    ...
                    this.hashNavigation.initialized &&
                        ...
                        (this.params.hashNavigation.replaceState && nt.history && nt.history.replaceState
                            ...
                            : ((e = (t = this.slides.eq(this.activeIndex)).attr("data-hash") || t.attr("data-history")), (m.location.hash = e || "")));
                },
                init: function () {
            ...
            dt = {
                setTranslate: function () {
                    ...
                    l.shadow &&
                        (h
                            ? (0 === (t = i.find(".swiper-cube-shadow")).length && ((t = z('<div class="swiper-cube-shadow"></div>')), i.append(t)), t.css({ height: n + "px" }))
                    ...
                    for (var u, p, f, m, g, v = 0; v < s.length; v += 1) {
                        ...
                        var _ = Math.max(Math.min(y[0].progress, 1), -1),
                            ...
                            T = 0,
                            E = 0;
                        b % 4 == 0 ? ((S = 4 * -x * r), (E = 0)) : (b - 1) % 4 == 0 ? ((S = 0), (E = 4 * -x * r)) : (b - 2) % 4 == 0 ? ((S = r + 4 * x * r), (E = r)) : (b - 3) % 4 == 0 && ((S = -r), (E = 3 * r + 4 * r * x)),
                            a && (S = -S),
                            h || ((T = S), (S = 0));
                        var C,
                            k,
                            M = "rotateX(" + (h ? 0 : -w) + "deg) rotateY(" + (h ? w : 0) + "deg) translate3d(" + S + "px, " + T + "px, " + E + "px)";
                        _ <= 1 && -1 < _ && (c = a ? 90 * -b - 90 * _ : 90 * b + 90 * _),
                            y.transform(M),
                            l.slideShadows &&
                                ((C = h ? y.find(".swiper-slide-shadow-left") : y.find(".swiper-slide-shadow-top")),
                                (k = h ? y.find(".swiper-slide-shadow-right") : y.find(".swiper-slide-shadow-bottom")),
                                0 === C.length && ((C = z('<div class="swiper-slide-shadow-' + (h ? "left" : "top") + '"></div>')), y.append(C)),
                                0 === k.length && ((k = z('<div class="swiper-slide-shadow-' + (h ? "right" : "bottom") + '"></div>')), y.append(k)),
                                C.length && (C[0].style.opacity = Math.max(-_, 0)),
                                k.length && (k[0].style.opacity = Math.max(_, 0)));
                    }
                    i.css({ "-webkit-transform-origin": "50% 50% -" + r / 2 + "px", "-moz-transform-origin": "50% 50% -" + r / 2 + "px", "-ms-transform-origin": "50% 50% -" + r / 2 + "px", "transform-origin": "50% 50% -" + r / 2 + "px" }),
                        l.shadow &&
                            (h
                                ...
                                : ((u = Math.abs(c) - 90 * Math.floor(Math.abs(c) / 90)),
                                  ...
                                  (m = l.shadowScale / p),
                                  (g = l.shadowOffset),
                                  t.transform("scale3d(" + f + ", 1, " + m + ") translate3d(0px, " + (o / 2 + g) + "px, " + -o / 2 / m + "px) rotateX(-90deg)")));
                ...
                setTranslate: function () {
                    for (var t = this.slides, e = this.rtlTranslate, i = 0; i < t.length; i += 1) {
                        ...
                        var o,
                            ...
                            d = 0;
                        this.isHorizontal() ? e && (r = -r) : ((d = h), (l = -r), (r = h = 0)),
                            (s[0].style.zIndex = -Math.abs(Math.round(n)) + t.length),
                            this.params.flipEffect.slideShadows &&
                                ((o = this.isHorizontal() ? s.find(".swiper-slide-shadow-left") : s.find(".swiper-slide-shadow-top")),
                                (a = this.isHorizontal() ? s.find(".swiper-slide-shadow-right") : s.find(".swiper-slide-shadow-bottom")),
                                0 === o.length && ((o = z('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>')), s.append(o)),
                                0 === a.length && ((a = z('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>')), s.append(a)),
                                o.length && (o[0].style.opacity = Math.max(-n, 0)),
                                a.length && (a[0].style.opacity = Math.max(n, 0))),
                            s.transform("translate3d(" + h + "px, " + d + "px, 0px) rotateX(" + l + "deg) rotateY(" + r + "deg)");
                    }
                },
                setTransition: function (t) {
                    var i,
            ...
            ut = {
                setTranslate: function () {
                    for (
                        ...
                        var w = a ? 0 : b * m,
                            x = a ? b * m : 0;
                        Math.abs(x) < 0.001 && (x = 0), Math.abs(w) < 0.001 && (w = 0), Math.abs(y) < 0.001 && (y = 0), Math.abs(g) < 0.001 && (g = 0), Math.abs(v) < 0.001 && (v = 0);
                        var _,
                            S,
                            T = "translate3d(" + x + "px," + w + "px," + y + "px)  rotateX(" + v + "deg) rotateY(" + g + "deg)";
                        p.transform(T),
                            (p[0].style.zIndex = 1 - Math.abs(Math.round(m))),
                            o.slideShadows &&
                                ((_ = a ? p.find(".swiper-slide-shadow-left") : p.find(".swiper-slide-shadow-top")),
                                (S = a ? p.find(".swiper-slide-shadow-right") : p.find(".swiper-slide-shadow-bottom")),
                                0 === _.length && ((_ = z('<div class="swiper-slide-shadow-' + (a ? "left" : "top") + '"></div>')), p.append(_)),
                                0 === S.length && ((S = z('<div class="swiper-slide-shadow-' + (a ? "right" : "bottom") + '"></div>')), p.append(S)),
            ...
            pt = {
                init: function () {
                    ...
                    t.swiper instanceof e
                        ? ((this.thumbs.swiper = t.swiper),
                          ot.extend(this.thumbs.swiper.originalParams, { watchSlidesProgress: !0, slideToClickedSlide: !1 }),
                          ot.extend(this.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 }))
                        : ot.isObject(t.swiper) && ((this.thumbs.swiper = new e(ot.extend({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))), (this.thumbs.swiperCreated = !0)),
                ...
                onThumbClick: function () {
                    ...
                    a &&
                        ((t = a.clickedIndex),
                        ((e = a.clickedSlide) && z(e).hasClass(this.params.thumbs.slideThumbActiveClass)) ||
                            null == t ||
                            ((o = a.params.loop ? parseInt(z(a.clickedSlide).attr("data-swiper-slide-index"), 10) : t),
                            this.params.loop &&
                                ((i = this.activeIndex),
                ...
                update: function (t) {
                    ...
                    if (e) {
                        var i,
                            ...
                            n,
                            o,
                            a = "auto" === e.params.slidesPerView ? e.slidesPerViewDynamic() : e.params.slidesPerView;
                            ...
                            (o = e.params.loop
                                ? (e.slides.eq(i).hasClass(e.params.slideDuplicateClass) && (e.loopFix(), (e._clientLeft = e.$wrapperEl[0].clientLeft), (i = e.activeIndex)),
                                  ...
                                  (n = e.slides
                                      ...
                                      .eq(0)
                                      .index()),
                                  void 0 === s ? n : void 0 === n ? s : n - i == i - s ? i : n - i < i - s ? n : s)
                                : this.realIndex),
                            e.visibleSlidesIndexes &&
                                e.visibleSlidesIndexes.indexOf(o) < 0 &&
                                (e.params.centeredSlides ? (o = i < o ? o - Math.floor(a / 2) + 1 : o + Math.floor(a / 2) - 1) : i < o && (o = o - a + 1), e.slideTo(o, t ? 0 : void 0)));
                        var r = 1,
                        ...
                        else for (var d = 0; d < r; d += 1) e.slides.eq(this.realIndex + d).addClass(l);
                    }
                },
            },
            ft = [
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { navigation: { init: Q.init.bind(this), update: Q.update.bind(this), destroy: Q.destroy.bind(this), onNextClick: Q.onNextClick.bind(this), onPrevClick: Q.onPrevClick.bind(this) } });
                    },
                    on: {
                        init: function () {
                        ...
                        click: function (t) {
                            ...
                            !this.params.navigation.hideOnClick ||
                                z(t.target).is(n) ||
                                z(t.target).is(s) ||
                                (s ? (e = s.hasClass(this.params.navigation.hiddenClass)) : n && (e = n.hasClass(this.params.navigation.hiddenClass)),
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { pagination: { init: K.init.bind(this), render: K.render.bind(this), update: K.update.bind(this), destroy: K.destroy.bind(this), dynamicBulletIndex: 0 } });
                    },
                    on: {
                        init: function () {
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { parallax: { setTransform: J.setTransform.bind(this), setTranslate: J.setTranslate.bind(this), setTransition: J.setTransition.bind(this) } });
                    },
                    on: {
                        beforeInit: function () {
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { lazy: { initialImageLoaded: !1, load: et.load.bind(this), loadInSlide: et.loadInSlide.bind(this) } });
                    },
                    on: {
                        beforeInit: function () {
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        ot.extend(e, { a11y: { liveRegion: z('<span class="' + e.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>') } }),
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, {
                            history: { init: at.init.bind(this), setHistory: at.setHistory.bind(this), setHistoryPopState: at.setHistoryPopState.bind(this), scrollToSlide: at.scrollToSlide.bind(this), destroy: at.destroy.bind(this) },
                        });
                    },
                    on: {
                        init: function () {
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { hashNavigation: { initialized: !1, init: rt.init.bind(this), destroy: rt.destroy.bind(this), setHash: rt.setHash.bind(this), onHashCange: rt.onHashCange.bind(this) } });
                    },
                    on: {
                        init: function () {
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { fadeEffect: { setTranslate: ht.setTranslate.bind(this), setTransition: ht.setTransition.bind(this) } });
                    },
                    on: {
                        beforeInit: function () {
                            var t;
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { cubeEffect: { setTranslate: dt.setTranslate.bind(this), setTransition: dt.setTransition.bind(this) } });
                    },
                    on: {
                        beforeInit: function () {
                            var t;
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { flipEffect: { setTranslate: ct.setTranslate.bind(this), setTransition: ct.setTransition.bind(this) } });
                    },
                    on: {
                        beforeInit: function () {
                            var t;
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { coverflowEffect: { setTranslate: ut.setTranslate.bind(this), setTransition: ut.setTransition.bind(this) } });
                    },
                    on: {
                        beforeInit: function () {
                ...
                },
                {
                    ...
                    create: function () {
                        ot.extend(this, { thumbs: { swiper: null, init: pt.init.bind(this), update: pt.update.bind(this), onThumbClick: pt.onThumbClick.bind(this) } });
                    },
                    on: {
                        beforeInit: function () {
                            var t = this.params.thumbs;
    ...
    (function () {
        ...
        (i.prototype.TYPES = ["line", "ellipse", "circle", "polygon", "polyline", "rect"]),
                    ...
                    t.rx || t.ry
                        ? ((e = parseInt(t.rx, 10) || -1),
                          ...
                          (s.d =
                              ...
                              "," +
                              o))
                        : (s.d = "M" + n + " " + o + " L" + (n + a) + " " + o + " L" + (n + a) + " " + (o + r) + " L" + n + " " + (o + r) + " Z"),
                    s
                );
            }),
            ...
            (n.prototype.mapping = function () {
                for (var t, e, i, s, n, o = (s = n = 0), a = this.el.querySelectorAll("path"), r = 0; r < a.length; r++)
                    (t = a[r]),
                        this.isInvisible(t) ||
                            ...
                            isNaN(i.length)
                                ...
                                : (this.map.push(i),
                                  ...
                                  this.renderPath(r)));
                for (
                    s = 0 === s ? 1 : s, this.delay = null === this.delay ? this.duration / 3 : this.delay, this.delayUnit = this.delay / (1 < a.length ? a.length - 1 : 1), this.reverseStack && this.map.reverse(), r = 0;
                    r < this.map.length;
                    r++
                ) {
        ...
        (e = this),
            (i = function (l, o) {
                ...
                return (
                        ...
                        return (
                            ...
                            l.each(t, function (t, r) {
                                return l.each(e.waypoints[t], function (t, e) {
                                    ...
                                    if (
                                        (l.isFunction(n) ? (n = n.apply(e.element)) : "string" == typeof n && ((n = parseFloat(n)), -1 < e.options.offset.indexOf("%") && (n = Math.ceil((r.contextDimension * n) / 100))),
                                        ...
                                        return null !== o && o < (i = r.oldScroll) && i <= e.offset
                                            ...
                                            : (null !== o && o > (s = r.oldScroll) && s >= e.offset) || (null === o && r.oldScroll >= e.offset)
                                            ? e.trigger([r.forward])
                                            : void 0;
                                });
                            })
                    ...
                    (l.fn[v].defaults = { context: o, continuous: !0, enabled: !0, horizontal: !1, offset: 0, triggerOnce: !1 }),
                    (u = {
                        refresh: function () {
